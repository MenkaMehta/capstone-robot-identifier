...
/**
 * Capstone Project - Robot Identifier Application
 * Created by Menka Mehta
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    {
        nfcHandler.disableForegroundDispatch();
        startActivity(new Intent(this, RobotIdentityWriter.class));
    }

    public void ReadTagMode_onClick(View v)
    {
        nfcHandler.disableForegroundDispatch();
        startActivity(new Intent(this, RobotIdentityReader.class));
    }
